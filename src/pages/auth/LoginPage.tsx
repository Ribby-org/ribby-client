...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl overflow-hidden flex min-h-[420px]">
        ...
        {/* ── Right panel ── */}
        <div className="relative w-64 lg:w-80 bg-gradient-to-br from-violet-500 via-indigo-500 to-blue-600 flex flex-col items-center justify-center p-8 overflow-hidden">
