    ...
    <Document title={`Ribby — ${reportTitle}`} author="Ribby" creator="Ribby">
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          {/* Methodology note */}
          <View style={{ backgroundColor: B.ultraLight, border: `1 solid ${B.lightGray}`, borderRadius: 6, padding: '10 14', marginBottom: 20 }}>
            <Text style={{ fontSize: 8, fontFamily: 'Helvetica-Bold', color: B.midGray, marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.4 }}>About This Report</Text>
